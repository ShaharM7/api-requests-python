...
class TestGetBooking:
    """Tests for GET /booking/:id"""

    def test_get_all_booking_ids_success(self, initialize_booking_client: BookingClient):
    ...
    def test_get_all_booking_ids_not_empty(self, initialize_booking_client: BookingClient):
    ...
    def test_get_all_booking_ids_valid_structure(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_by_id_success(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_by_id_valid_structure(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_by_id_returns_correct_data(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_invalid_id(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_invalid_id_raw(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_ids_filter_by_firstname(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_ids_filter_by_lastname(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_ids_filter_by_dates(self, initialize_booking_client: BookingClient):
        ...
        # Act - Filter by checkin and checkout dates
        filters_dates = BookingRequest(checkin=checkin, checkout=checkout)
        filtered_ids: list[int] = initialize_booking_client.get_booking_ids_by_filter(filters=filters_dates)

        # Assert
        assert created_booking_id in filtered_ids, \
            f"Created booking ID {created_booking_id} should be in filtered results"

    def test_get_booking_ids_filter_combination(self, initialize_booking_client: BookingClient):
    ...
    def test_get_booking_ids_filter_no_results(self, initialize_booking_client: BookingClient):
