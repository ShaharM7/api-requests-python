...
def test_create_booking_success(initialize_booking_client: BookingClient):
...
def test_create_booking_returns_correct_data(initialize_booking_client: BookingClient):
...
def test_create_booking_generates_unique_id(initialize_booking_client: BookingClient):
...
def test_create_booking_verify_persisted(initialize_booking_client: BookingClient):
...
def test_create_booking_with_additionalneeds(initialize_booking_client: BookingClient):
...
def test_create_booking_with_minimum_data(initialize_booking_client: BookingClient):
...
def test_create_booking_with_special_characters(initialize_booking_client: BookingClient):
...
def test_create_booking_depositpaid_true(initialize_booking_client: BookingClient):
...
def test_create_booking_depositpaid_false(initialize_booking_client: BookingClient):
...
def test_create_booking_various_prices(initialize_booking_client: BookingClient, price: int):
...
def test_create_booking_missing_required_field(initialize_booking_client: BookingClient):
